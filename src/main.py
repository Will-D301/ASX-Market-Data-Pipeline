...
from src.models.position_maker import bayesian_back_test, save_back_test
from src.models.bayesian_alpha_beta_model.predict_probabilities import compute_probabilities, open_pred_prob_data
from src.models.bayesian_alpha_beta_model.prediction_data_creation import compute_adj_open, compute_prob_gapup, open_prob_data
from src.data_collection.duckdb_collection import connect, init_all_views
...
from src.config import BAYESIAN_DATA_PATH

training_start_date = '2000-02-01'
...
def main() -> None:
    ...
    # Bayesian Back Test
    positions = bayesian_back_test(pred_prob_data, 0.45, 0.55)
    save_back_test(positions, con, "bt_4555split", BAYESIAN_DATA_PATH)
